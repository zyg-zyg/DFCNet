...
class GroupMambaLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        # SCAN_DIRECTIONS = [
        #     (CrossScan_1, CrossMerge_1),  # 例如：正向水平
        #     (CrossScan_2, CrossMerge_2),  # 例如：反向水平
        #     (CrossScan_3, CrossMerge_3),  # 例如：反向垂直
        #     (CrossScan_4, CrossMerge_4),  # 例如：正向向垂直
        # ]
        # selected_scan_pair = random.choice(SCAN_DIRECTIONS)
        # x_mamba1 = self.mamba_g1(x1, CrossScan=selected_scan_pair[0], CrossMerge=selected_scan_pair[1])
        # selected_scan_pair = random.choice(SCAN_DIRECTIONS)
        # x_mamba2 = self.mamba_g2(x2, CrossScan=selected_scan_pair[0], CrossMerge=selected_scan_pair[1])
        # selected_scan_pair = random.choice(SCAN_DIRECTIONS)
        # x_mamba3 = self.mamba_g3(x3, CrossScan=selected_scan_pair[0], CrossMerge=selected_scan_pair[1])
        # selected_scan_pair = random.choice(SCAN_DIRECTIONS)
        # x_mamba4 = self.mamba_g4(x4, CrossScan=selected_scan_pair[0], CrossMerge=selected_scan_pair[1])
